...
Данное приложение используется для сохранения своего списка прочитанных книг. Оно демонстрирует пример взаимодействия с [Assistant Client](https://github.com/salute-developers/salutejs-client).
